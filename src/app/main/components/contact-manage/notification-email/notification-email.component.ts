...
import { NotificationEmail } from 'src/app/main/models/notification-email/notification-email.model';
...
export class NotificationEmailComponent implements OnInit {
  ...
  public datas: NotificationEmail[] = [];
  ...
  constructor(
    ...
    this.title.setTitle('Danh sách Email thông báo');
  }
  ...
  private loadData() {
    this.contactManageService.listNotificationEmail(this.event).subscribe((response) => {
  ...
  public delete(id: number) {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.contactManageService.deleteNotificationEmail(id).subscribe((response) => {
